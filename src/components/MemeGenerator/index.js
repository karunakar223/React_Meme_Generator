...
class MemeGenerator extends Component {
  ...
  onChangeFontSizeChangeOptionId = event => {
    ...
    return (
      <MemeGeneratorForm onSubmit={this.onGenerateMeme}>
        ...
        <CustomSelect
          ...
          onChange={this.onChangeFontSizeChangeOptionId}
        >
          {fontSizesOptionsList.map(eachOpt => (
            <CustomOption key={eachOpt.optionId} value={eachOpt.optionId}>
              {eachOpt.displayText}
            </CustomOption>
          ))}
        </CustomSelect>
